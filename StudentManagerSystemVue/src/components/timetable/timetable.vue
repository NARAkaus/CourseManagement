    ...
    <el-card style="margin: 10px; padding: 10px 10px 0 10px; height: 80vh">
        <el-row>
            <el-button
                ...
                v-if="this.userInfo.level === 0"
                >{{ showContent ? "编辑" : "取消" }}</el-button
            >
            <el-button
                type="success"
                size="small"
                ...
                v-if="this.userInfo.level === 0"
                :disabled="
                    form.grade === '' || form.year === '' || form.term === ''
                "
                >录入</el-button
            >
            <el-button
        ...
        <el-collapse-transition v-if="userInfo.level === 0 || userInfo.level === 1">
            <el-form
                ref="form"
                :model="form"
                label-width="80px"
...
export default {
    ...
    methods: {
        ...
        getProfessionByAdmin() {
            this.axiosHelper
                .get("/api/sms/teacher/course/getProfessionInfoByAdmin")
                .then((response) => {
        ...
        gradeChange() {
            ...
            if (this.form.grade !== "") {
                ...
                // 筛选获取课程表
                this.axiosHelper
                    .get("/api/sms/timetable/getTimetable", { params: obj })
                    .then((response) => {
        ...
        addTimetable() {
            ...
            this.axiosHelper
                .post("/api/sms/timetable", this.dataTable)
                .then(() => {
                    this.doneNum = 0;
        ...
        getTimetableByStudent() {
            ...
            this.axiosHelper
                .get("/api/sms/timetable/getTimetableByStudent", {
                    params: obj,
                })
                .then((response) => {
                    let data = response.data;
        ...
        getTimetableByTeacher() {
            ...
            this.axiosHelper
                .get("/api/sms/timetable/getTimetableByTeacher", {
                    params: obj,
                })
                .then((response) => {
                    let data = response.data;
