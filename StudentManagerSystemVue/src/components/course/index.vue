          ...
          <el-col :span="12">
            <el-form-item label="上传作业:" prop="name">
              <el-upload class="upload"
                         ref="upload"
                         action="http://localhost:9121/api/sms/courseware/upload"
                         :file-list="fileList"
...
import VmHomework from '../../components/course/model/homework-model'
...
export default {
  ...
  data () {
    return {
      ...
      dataTable: [],
      dataColumns: [
        { label: '课程名称', prop: 'name', style: 'center', minWidth: '120' },
        { label: '课件描述', prop: 'desc', style: 'center', minWidth: '120' },
        { label: '课件名称', prop: 'attachmentname', style: 'center', minWidth: '120' },
        { label: '发布人', prop: 'creater', style: 'center', minWidth: '120' },
        { label: '发布时间', prop: 'addtime', style: 'center', minWidth: '120' },
        {
          label: '操作',
          style: 'center',
          prop: 'id',
          ...
          render: (h, params) => {
            ...
            if( this.userInfo.level == 0 ){
              ...
              btns.push(this.getOpBtn(h, '下载课件', 'success', () => {
  ...
  methods: {
    ...
    search() {
      ...
      this.axiosHelper.get(
        '/api/sms/courseware/getHomeworkList',
