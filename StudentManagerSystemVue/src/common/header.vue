<template>
    <div style="color: white;">
        ...
        ></i>
        <div class="misName">欢迎使用课程管理系统</div>
        <div style="float: right; margin-right: 16px">
            <!--日期-->
            <div class="font" v-html="day"></div>
            <!--头像-->
            <div class="headerStr">
                <el-avatar v-if="imageUrl != undefined" shape="square" :size="50" :src="$store.state.baseApi + imageUrl" :key="$store.state.baseApi + imageUrl" style="margin-top: 5px;"></el-avatar>
            </div>
            <!--用户名-->
            <div
                style="
